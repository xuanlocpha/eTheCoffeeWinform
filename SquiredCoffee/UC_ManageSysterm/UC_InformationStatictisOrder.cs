...
{
    public partial class UC_InformationStatictisOrder : UserControl
    {
        public int total;
        ...
        UC_ManageChart _parent;
        public UC_InformationStatictisOrder(UC_ManageChart parent)
        {
            InitializeComponent();
            _parent = parent;
        }
        ...
        public void Display()
        {
            clear();
            dgvOrder.Rows.Clear();
            List<OrderShow2> orderList = DbOrder.LoadShowOrderSearch(key);
        ...
        private void FormInformationStatisticalOrder_Load(object sender, EventArgs e)
        {
            lblTitle.Text = "Thống Kê Hóa Đơn" + " " + title;
            Display();
        }
        ...
        private void UC_InformationStatictisOrder_Load(object sender, EventArgs e)
        {
            lblTitle.Text = "Thống Kê Hóa Đơn" + " " + title;
            Display();
        }
