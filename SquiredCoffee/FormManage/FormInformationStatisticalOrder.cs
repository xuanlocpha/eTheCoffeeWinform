...
{
    public partial class FormInformationStatisticalOrder : Form
    {
        public int total;
        ...
        public FormInformationStatisticalOrder(UC_ManageChart parent)
        {
            InitializeComponent();
            _parent = parent;
        }
        ...
        public void Display()
        {
            ...
            foreach (OrderShow2 item in orderList)
            {
                ...
                lblRevenue.Text = string.Format("{0:#,##0} đ", totalOrder);
            }
        }
